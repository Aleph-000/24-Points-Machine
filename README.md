...
于是，我写了一个24点机器，可以遍历所有的组合（包括根号等运算符）
...
**示例：** 用$114,514,19,19,8,10$计算24点。

**解答：**
$$\frac{114 + 514 - 8}{10} - (19 + 19) = 24 \\[1em]$$
$$8 \log_2 \left( 19 + 19 - (10 + \sqrt{514 - 114}) \right) = 24 \\[1em]$$
...
```bash
g++ -O2 -std=c++17 -o hegel24 main.cpp
```
